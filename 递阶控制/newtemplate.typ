...
#Quotation("路欣")[“聘为浙大教师的学历要求起步就有‘有海外学习、科研经历并取得一定的学术成果的博士’。一个典型的晋升路径，如浙大有‘百人计划’，在六年内带领学生满足一定的教学要求，开展自己的实验室建设，并在这个平台上发表高水平的研究成果，三四年左右成为教授，之后经过院系、学部、学校的层层考核，升任长聘教授。”
]
